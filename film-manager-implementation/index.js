...
const apiFilmsPublicFilmIdReviewsReviewerIdDrafts = require('./controllers/ApifilmspublicfilmIdreviewsreviewerIddrafts.js');
const apiFilmsPublicFilmIdReviewsReviewerIdDraftsCurrent = require('./controllers/ApifilmspublicfilmIdreviewsreviewerIddraftscurrent.js');
const apiFilmsPublicFilmIdReviewsReviewerIdCoreviewer = require('./controllers/ApifilmspublicfilmIdreviewsreviewerIdcoreviewer.js');
...
const apiFilmsPublicCoreviewerInvited = require('./controllers/Apifilmspubliccoreviewerinvited.js');
...
const apiUsersUserIdSelection = require('./controllers/ApiusersuserIdselection.js');
...
app.get('/api/films/public/coreviewer-invited', isLoggedIn, apiFilmsPublicCoreviewerInvited.getCoreviewerInvitedFilms);
...
app.put('/api/films/public/:filmId/reviews/:reviewerId', isLoggedIn, validate({ body: reviewSchema }), apiFilmsPublicFilmIdReviewsReviewerId.completeSingleReview);
...
// New route for selecting active film
app.put('/api/users/:userId/selection', isLoggedIn, apiUsersUserIdSelection.selectActiveFilm);
